...
public class GroupsController {
    ...
    @GetMapping("/group")
    public String singleGroup(@RequestParam Long groupId,
    ...
    public String createSingleGroup(@RequestParam String groupNumber,
    ...
    @ResponseBody
    public ResponseEntity<InputStreamResource> getGroupList(@RequestParam Long groupId) throws IOException {
        MediaType contentType = MediaType.APPLICATION_OCTET_STREAM;
        return ResponseEntity.ok()
                .contentType(contentType)
                .header("Content-Disposition",
                        "attachment;filename=group-list-" + groupService.findById(groupId).getGroupNum() + ".txt"
                ).body(
